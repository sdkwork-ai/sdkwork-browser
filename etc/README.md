# sdkwork-browser Source Configuration
...
| Item | Value |
| --- | --- |
| `appId` | `sdkwork-browser` |
| `runtimeCode` | `browser` |
| Config root | `/etc/sdkwork/browser/` |
| Runtime TOML | `/etc/sdkwork/browser/config.toml` |
| Secrets | `/etc/sdkwork/browser/secrets/` |
| Override | `SDKWORK_BROWSER_CONFIG_FILE` |
