# Runbook — sdkwork-browser deploy / upgrade / rollback (EN)
...
targets. Image reference: `registry.sdkwork.com/apps/sdkwork-browser-standalone:0.1.0`
...
install syncs the bundle to `/opt/deploy/sdkwork-browser/bundle`, loads the image, starts
