...
```bash
npm install @sdkwork/browser-app-sdk
# or
yarn add @sdkwork/browser-app-sdk
# or
pnpm add @sdkwork/browser-app-sdk
```

## Quick Start

```typescript
import { SdkworkAppClient } from '@sdkwork/browser-app-sdk';
...
```typescript
import { SdkworkAppClient, NetworkError, TimeoutError, AuthenticationError } from '@sdkwork/browser-app-sdk';
